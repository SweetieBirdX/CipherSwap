...
exports.RealOnchainExecutionService = void 0;
...
var RealOnchainExecutionService = /** @class */ (function () {
    function RealOnchainExecutionService() {
        ...
        logger_1.logger.info('RealOnchainExecutionService initialized', {
     ...
     */
    RealOnchainExecutionService.prototype.executeLimitOrderOnchain = function (params) {
     ...
     */
    RealOnchainExecutionService.prototype.estimateGasForExecution = function (order, params) {
        return __awaiter(this, void 0, void 0, function () {
            var gasEstimate, apiGasEstimate, apiError_1, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 5]);
                        return [4 /*yield*/, this.getGasEstimateFrom1inchAPI(order, params)];
                    case 2:
                        apiGasEstimate = _a.sent();
                        gasEstimate = apiGasEstimate;
                        logger_1.logger.info('Gas estimation from 1inch API successful', {
                            orderId: params.orderId,
                    ...
                    case 3:
                        apiError_1 = _a.sent();
                        logger_1.logger.warn('1inch API gas estimation failed, using fallback', {
                            error: apiError_1.message,
                            orderId: params.orderId,
                            timestamp: Date.now(),
                            service: 'cipherswap-real-onchain-execution'
                        });
                        return [4 /*yield*/, this.fallbackGasEstimation(order, params)];
                    case 4:
     ...
     */
    RealOnchainExecutionService.prototype.getGasEstimateFrom1inchAPI = function (order, params) {
        return __awaiter(this, void 0, void 0, function () {
            var response, quoteData, gasLimit, gasPrice, maxPriorityFeePerGas, maxFeePerGas, totalCost, error_3;
            var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, axios_1.default.get("https://api.1inch.dev/swap/v5.2/quote", {
                                headers: {
                                    'Authorization': "Bearer ".concat(process.env.INCH_API_KEY),
                    ...
                    case 1:
                        ...
                        gasLimit = ((_a = quoteData.tx) === null || _a === void 0 ? void 0 : _a.gas) || '210000';
                        gasPrice = params.gasPrice || ((_b = quoteData.tx) === null || _b === void 0 ? void 0 : _b.gasPrice) || '20000000000';
                        maxPriorityFeePerGas = params.maxPriorityFeePerGas || '2000000000';
                        maxFeePerGas = params.maxFeePerGas || '20000000000';
                        totalCost = ((_c = quoteData.tx) === null || _c === void 0 ? void 0 : _c.value) || '0';
                        logger_1.logger.info('1inch API gas estimation successful', {
                            orderId: params.orderId,
                            gasLimit: gasLimit,
                            gasPrice: gasPrice,
                            totalCost: totalCost,
                    ...
                    case 2:
                        error_3 = _d.sent();
                        logger_1.logger.error('1inch API gas estimation failed', {
     ...
     */
    RealOnchainExecutionService.prototype.fallbackGasEstimation = function (order, params) {
        return __awaiter(this, void 0, void 0, function () {
            var feeData, complexityMultiplier, baseGasLimit, gasLimit, gasPrice, maxPriorityFeePerGas, maxFeePerGas, totalCost, error_4;
            var _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        baseGasLimit = 210000;
                        gasLimit = Math.floor(baseGasLimit * complexityMultiplier).toString();
                        gasPrice = params.gasPrice || ((_a = feeData.gasPrice) === null || _a === void 0 ? void 0 : _a.toString()) || '20000000000';
                        ...
                        maxFeePerGas = params.maxFeePerGas || ((_c = feeData.maxFeePerGas) === null || _c === void 0 ? void 0 : _c.toString()) || '20000000000';
                    ...
                    case 2:
                        error_4 = _d.sent();
                        logger_1.logger.error('Fallback gas estimation failed', {
     ...
     */
    RealOnchainExecutionService.prototype.executeTransaction = function (order, gasEstimate, params) {
        return __awaiter(this, void 0, void 0, function () {
            var transactionData, signedTx, txResponse, receipt, transactionResult, error_5;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: "Transaction execution failed: ".concat(error_5.message)
                            }];
     ...
     */
    RealOnchainExecutionService.prototype.createLimitOrderTransaction = function (order, gasEstimate) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    RealOnchainExecutionService.prototype.encodeLimitOrderExecution = function (order) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    RealOnchainExecutionService.prototype.calculateComplexityMultiplier = function (order) {
        var multiplier = 1.0;
        // Base complexity
        multiplier += 0.2;
        // Amount complexity
     ...
     */
    RealOnchainExecutionService.prototype.getTransactionStatus = function (txHash) {
        return __awaiter(this, void 0, void 0, function () {
            var receipt, transactionResult, error_6;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: "Get transaction status failed: ".concat(error_6.message)
                            }];
                    case 3: return [2 /*return*/];
                }
            });
     ...
     */
    RealOnchainExecutionService.prototype.cancelLimitOrderOnchain = function (orderId, userAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var orderResponse, order, cancellationData, signedTx, txResponse, receipt, updatedOrder, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 7:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                error: "Cancel limit order failed: ".concat(error_7.message)
                            }];
                    case 8: return [2 /*return*/];
                }
            });
     ...
     */
    RealOnchainExecutionService.prototype.createCancellationTransaction = function (order) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    return RealOnchainExecutionService;
}());
exports.RealOnchainExecutionService = RealOnchainExecutionService;
